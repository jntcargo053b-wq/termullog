...
class WatermarkEngine {
  ...
  static void _drawClassic(
    ...
    if (miniMapImage != null && p.showMiniMap) {
      ...
      final double mapY = stripY - mapSize - 8 * pr;
      if (mapY >= 8 * pr) {
  ...
  static void _drawMinimal(
    ...
    canvas.drawRRect(
      rr,
      ui.Paint()..color = const ui.Color(0xDD000000).withOpacity(p.opacity * 0.85),
    );
    canvas.drawRRect(
  ...
  static void _drawCard(
    ...
    canvas.drawRRect(
      ...
      ui.Paint()..color = ui.Color.fromRGBO(8, 12, 24, p.opacity.clamp(0.6, 0.96)),
    );
    ...
    if (miniMapImage != null && p.showMiniMap) {
      ...
      if (mapY > cy + 40 * pr) {
        ...
        canvas.drawRect(
          Rect.fromLTWH(mapX, mapY, mapSize, mapSize),
          ui.Paint()
            ..color = const ui.Color(0xAA1E90FF)
            ..style = PaintingStyle.stroke
            ..strokeWidth = 1.5,
        );
      }
  ...
  static void _drawFilm(
    ...
    canvas.drawRect(
      ...
      ui.Paint()..color = const ui.Color(0xFF1A1000),
    );
    canvas.drawRect(
  ...
  static ui.TextPainter _makePainter(
    ...
    final span = TextSpan(
      ...
      style: TextStyle(
        ...
        height: 1.2,
        shadows: const [
          Shadow(blurRadius: 4, color: ui.Color(0x88000000), offset: Offset(1, 1)),
        ],
      ),
    );
